        ...
        <div class="app-content">
            ...
            <div class="container-fluid"> <!--begin::Row-->
                <div class="row"> <!--begin::Col-->
                    <div class="card">
                        <form action="{{ route('admins.LopHocCreatePOST') }}" method="POST">
                            @csrf
                            <div class="card-header">
                                <h2 class="text-center">THÊM LỚP HỌC MỚI</h2>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="form-group my-3">
                                    ...
                                    <select name="gvcn" id="gvcn" required class="form-control">
                                        ...
                                        @foreach ($data as $item)
                                            <option value="{{ $item->IDGV }}" class="text-center">{{ $item->TenGV }}</option>
                                        @endforeach
